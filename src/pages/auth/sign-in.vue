<template>
  <div class="flex flex-col items-center justify-center">
    <div class="mx-auto w-full sm:w-1/3 p-10 mt-16">
      <div class="text-center text-5xl sm:text-3xl font-bold text-slate-700 mb-10 sm:mb-5">
        Sign in to <span class="text-yellow-600">Tortuga</span>.
      </div>
      <div class="text-center">
        <input
          type="email"
          class="p-2 m-2 bg-white w-11/12 text-2xl sm:text-base rounded outline-none border-2 border-slate-400 focus:border-2 focus:border-yellow-500"
      ...
      <div class="text-center">
        <button
          @click="authenticate"
          class="p-2 m-2 bg-red-700 text-2xl sm:text-base cursor-pointer font-semibold w-11/12 rounded text-white mt-5"
        >
          Sign In
        </button>
      </div>
      ...
      <div class="px-4 pt-5 text-xl sm:text-sm text-center">
